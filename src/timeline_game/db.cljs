...
(def cards [{:title "Stvoření", :year -9999, :time-desc "„Na počátku“" :img-name "1"}
            ...
            {:title "Samaritánka", :year 30, :time-desc "30 n.l." :img-name "91"}
            {:title "Očista chrámu", :year 30, :time-desc "30 n.l." :img-name "90"}
            {:title "Ježíš a děti", :year 31, :time-desc "31-33 n.l." :img-name "96"}
            {:title "Samaritán", :year 31, :time-desc "31-33 n.l." :img-name "97"}
            {:title "Nasycení tisíců lidí", :year 31, :time-desc "31-33 n.l." :img-name "95"}
            {:title "Jairova dcera", :year 31, :time-desc "31-33 n.l." :img-name "94"}
            {:title "Ježíš léčí", :year 31, :time-desc "31-33 n.l." :img-name "93"}
            {:title "Kázání na hoře", :year 31, :time-desc "31 n.l." :img-name "92"}
            {:title "Návrat do nebe", :year 33, :time-desc "33 n.l." :img-name "106"}
            {:title "Svatý duch", :year 33, :time-desc "33 n.l." :img-name "107"}
            {:title "Tomáš", :year 33, :time-desc "33 n.l." :img-name "105"}
            {:title "Ježíš vzkříšen", :year 33, :time-desc "33 n.l." :img-name "104"}
            {:title "Výkupní oběť", :year 33, :time-desc "33 n.l." :img-name "103"}
            {:title "Jidáš", :year 33, :time-desc "33 n.l." :img-name "102"}
            {:title "Pánova večeře", :year 33, :time-desc "33 n.l." :img-name "101"}
            {:title "„Kdy to bude?“", :year 33, :time-desc "33 n.l." :img-name "99"}
            {:title "Král na oslátku", :year 33, :time-desc "33 n.l." :img-name "98"}
            {:title "Propuštění z vězení", :year 33, :time-desc "33 n.l." :img-name "109"}
            {:title "Saul z Tarsu", :year 34, :time-desc "34 n.l." :img-name "111"}
            {:title "Štěpán", :year 34, :time-desc "34 n.l." :img-name "110"}
            {:title "Kornelius", :year 36, :time-desc "36 n.l." :img-name "112"}
            {:title "Pavel a Timoteus", :year 47, :time-desc "47-52 n.l." :img-name "113"}
            {:title "Eutychos", :year 52, :time-desc "52-56 n.l." :img-name "114"}
            {:title "Ztroskotání", :year 58, :time-desc "58-59 n.l." :img-name "116"}
            {:title "Pavel v Římě", :year 59, :time-desc "59-61 n.l." :img-name "117"}
            {:title "Zjevení Janovi", :year 96, :time-desc "96 n.l." :img-name "119"}
            {:title "„Nová země“", :year 9999, :time-desc "Již brzy..." :img-name "120"}])
